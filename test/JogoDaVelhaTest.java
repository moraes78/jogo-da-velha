...
public class JogoDaVelhaTest {
	...
	@Test
	public void deveAlterarPosicaoZeroZeroDoTabuleiroComJogadorBola()
			throws Exception {
	...
	@Test
	public void deveAlterarPosicaoZeroDoisDoTabuleiroComJogadorXis()
			throws Exception {
	...
	public void naoDeveAlterarPosicaoUmDoisJaOcupadaPeloJogadorBola()
			throws Exception {
	...
	@Test(expected = JogoDaVelhaException.class)
	public void naoDeveAlterarPosicaoDoisDoisJaOcupadaPeloJogadorXis()
			throws Exception {
		String[][] tabuleiroInicial = new String[][] { { "", "", "" },
													   { "", "", "" }, 
													   { "", "", "X" } };
	...
	@Test(expected = JogoDaVelhaException.class)
	public void naoDeveAlterarPosicaoUmUmJaOcupadaPeloProprioJogador()
			throws Exception {
		String[][] tabuleiroInicial = new String[][] { { "", "", "" },
													   { "", "O", "" }, 
													   { "", "", "" } };
	...
	@Test(expected = JogoDaVelhaException.class)
	public void naoDevePermitirPosicaoDoisSeisForaDoTabuleiro()
			throws Exception {
		String[][] tabuleiroInicial = new String[][] { { "", "", "" },
													   { "", "", "" }, 
													   { "", "", "" } };
	...
	@Test(expected = JogoDaVelhaException.class)
	public void naoDevePermitirPosicaoDoisTresForaDoTabuleiro()
			throws Exception {
		String[][] tabuleiroInicial = new String[][] { { "", "", "" },
				 									   { "", "", "" }, 
				 									   { "", "", "" } };
	...
	@Test
	public void naoDeveConfirmarGanhadorXisPrimeiraLinhaIncompleta()
			throws Exception {
	...
	@Test
	public void naoDeveConfirmarGanhadorXisSegundaLinhaIncompleta()
			throws Exception {
		String[][] tabuleiroInicial = new String[][] { { "", "", "" },
													   { "X", "X", "" }, 
													   { "", "", "" } };
	...
	@Test
	public void naoDeveConfirmarGanhadorXisTerceiraLinhaIncompleta()
			throws Exception {
		String[][] tabuleiroInicial = new String[][] { { "", "", "" },
													   { "", "", "" }, 
													   { "", "X", "X" } };
	...
	@Test
	public void naoDeveConfirmarGanhadorBolaPrimeiraLinhaIncompleta()
			throws Exception {
	...
	@Test
	public void naoDeveConfirmarGanhadorBolaSegundaLinhaIncompleta()
			throws Exception {
		String[][] tabuleiroInicial = new String[][] { { "", "", "" },
													   { "O", "O", "" }, 
													   { "", "", "" } };
	...
	@Test
	public void naoDeveConfirmarGanhadorBolaTerceiraLinhaIncompleta()
			throws Exception {
		String[][] tabuleiroInicial = new String[][] { { "", "", "" },
													   { "", "", "" }, 
													   { "", "O", "O" } };
	...
	@Test
	public void naoDeveConfirmarGanhadorBolaTerceiraDiagonalIncompleta()
			throws Exception {
	...
	@Test
	public void deveConfirmarGanhadorXisDiagonalEsquerda() throws Exception {
		String[][] tabuleiroInicial = new String[][] { { "X", "", "" },
													   { "", "X", "" }, 
													   { "", "", "X" } };
		boolean existeGanhador = JogoDaVelha.existeGanhador(tabuleiroInicial,"X");
	...
	@Test
	public void deveConfirmarGanhadorXisDiagonalDireita() throws Exception {
		String[][] tabuleiroInicial = new String[][] { { "", "", "X" },
													   { "", "X", "" }, 
													   { "X", "", "" } };
		boolean existeGanhador = JogoDaVelha.existeGanhador(tabuleiroInicial,"X");
	...
	@Test
	public void deveConfirmarGanhadorBolaDiagonalEsquerda() throws Exception {
		String[][] tabuleiroInicial = new String[][] { { "O", "", "" },
													   { "", "O", "" }, 
													   { "", "", "O" } };
		boolean existeGanhador = JogoDaVelha.existeGanhador(tabuleiroInicial,"O");
	...
	@Test
	public void deveConfirmarGanhadorBolaDiagonalDireita() throws Exception {
		String[][] tabuleiroInicial = new String[][] { { "", "", "O" },
													   { "", "O", "" }, 
													   { "O", "", "" } };
		boolean existeGanhador = JogoDaVelha.existeGanhador(tabuleiroInicial,"O");
